    ...
    <main class="w-full">
        ...
        <div class="mx-10 mt-8">
            <div class="bg-white2 shadow-lg rounded-lg border">
                <h1 class="text-primary text-center font-bold mx-5 mt-5">Kutipan Akta Kematian</h1>

                <div class="mt-10">
                    <div class="mx-16">
                        <h1 class="text-primary font-bold">Data Pelapor</h1>

                        <form action="/aktaKematian" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="jenis_berkas" value="Kutipan Akta Kematian">
                            ...
                            <div class="mt-10">
                                ...
                                <div class="">
                                    <div class="flex items-center mt-8 mb-5">
                                        ...
                                        <span class="text-primary font-bold mx-5">Kartu Keluarga (KK) yang Meninggal</span>
                                    </div>
                                ...
                                <div class="">
                                    <div class="flex items-center mt-8 mb-5">
                                        <img src="/img/layanan_online/layanan_kia.png" alt="">
                                        <span class="text-primary font-bold mx-5">KTP yang Meninggal</span>
                                    </div>
                                ...
                                <div class="">
                                    <div class="flex items-center mt-8 mb-5">
                                        <img src="/img/layanan_online/layanan_kia.png" alt="">
                                        <span class="text-primary font-bold mx-5">Surat Keterangan Kematian</span>
                                    </div>
