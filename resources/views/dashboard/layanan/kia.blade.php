    ...
    <main class="w-full">
        ...
        <div class="mx-10 mt-8">
            <div class="bg-white2 shadow-lg rounded-lg border">
                <h1 class="text-primary text-center font-bold mx-5 mt-5">Kartu Identitas Anak (KIA)</h1>

                <div class="">
                    <div class="mx-16">
                        <form action="/kia" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="jenis_berkas" value="Kartu Identitas Anak">
                            ...
                            <h1 class="text-primary font-bold mt-12">Unggah Dokumen Persyaratan</h1>
                            <h5 class="text-sm text-slate-500 mt-1">Tipe file yang anda dapat unggah berupa pdf, png, jpg,
                                dan jpeg</h5>
                            ...
                            <div class="">
                                ...
                                <label
                                    ...
                                    <input id="photo-dropbox" name="berkas[]" type="file" class="sr-only" />
                                </label>
                            </div>

                            <div class="">
                                <div class="flex items-center mt-8 mb-5">
                                    <img src="/img/layanan_online/akta-lahir-icon.png" alt="">
                                    <span class="text-primary font-bold mx-5">Akta Kelahiran (KK)</span>
                                </div>
                            ...
                            <div class="">
                                <div class="flex items-center mt-8 mb-5">
                                    <img src="/img/layanan_online/formulir-icon.png" alt="">
                            ...
                            <div class="">
                                <div class="flex items-center mt-8 mb-5">
                                    <img src="/img/layanan_online/ktp-icon.png" alt="">
                                    <span class="text-primary font-bold mx-5">KTP Orang Tua</span>
                                </div>
                            ...
                            <div class="">
                                <div class="flex items-center mt-8 mb-5">
                                    <img src="/img/layanan_online/pas-foto-icon.png" alt="">
                                    <span class="text-primary font-bold mx-5">Pas Foto Anak</span>
                                </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="modal-content py-4 text-left px-6">
                                ...
                                <!--Body-->
                                <p class="text-sm">Berkas yang anda ajukan tidak bisa diedit. Anda yakin ingin mengajukan
                                    berkas?</p>
