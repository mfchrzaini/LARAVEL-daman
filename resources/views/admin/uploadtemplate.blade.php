...
@section('main')
    <main class="w-full">
        <h1 class="text-primary font-bold ml-10 my-10">Unggah</h1>

        <section class="mx-10 bg-primary block py-2 text-center text-white font-semibold rounded-lg">Unggah Formulir
        </section>
                    ...
                    <div class="">
                        <form action="/template" method="post" enctype="multipart/form-data">
                            ...
                            <div class="relative h-11 w-full min-w-[200px] mt-14">
                                <input placeholder="Judul" name="nama_file"
                                ...
                                <label
                                    ...
                                    <span class="text-primary font-bold">Judul</span>
                                </label>
                            </div>
                    </div>
                    <div class="mt-10">
                        <h1 class="text-primary font-bold">Unggah Dokumen Persyaratan</h1>
                        <h5 class="text-sm text-slate-400 mt-1">Tipe file yang anda dapat unggah berupa pdf, png, jpg, dan
                            jpeg</h5>

                        <div class="">
                            <div class="flex items-center mt-8 mb-5">
                                <img src="/img/layanan_online/layanan_kia.png" alt="">
                                <span class="text-primary font-bold mx-5">Unggah File</span>
                            </div>
                            ...
                            <label
                                ...
                                <input id="photo-dropbox" type="file" name="pdf" accept=".pdf" class="sr-only" />
                            </label>
                        </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="modal-content py-4 text-left px-6">
                                    ...
                                    <!--Body-->
                                    <p class="text-sm">Anda yakin ingin menggunggah berkas?</p>
